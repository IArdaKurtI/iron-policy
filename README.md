...
Completed training records can be opened, watched, or deleted from the Training Records screen. Watch loads the Leo and T-90 final models from the selected seed; it is only enabled when both final model files exist.
